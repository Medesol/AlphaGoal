from gym.spaces import Discrete,Box, MultiDiscrete, Tuple as TupleSpace
import logging
import numpy as np
import random
import time
...
class Unity3DEnv(MultiAgentEnv):
    ...
    def get_policy_configs_for_game(
        ...
        obs_spaces = {
            ...
            "Striker": TupleSpace([
                Box(float("-inf"), float("inf"), (264, )),
                Box(float("-inf"), float("inf"), (72, )),
            ]),
        ...
        if game_name == "SoccerTwos":
            policies = {
                "Goalie": (None, obs_spaces["Goalie"], action_spaces["Goalie"],
                           {}),
                "SoccerTwos": (None, obs_spaces["SoccerTwos"],
                            action_spaces["SoccerTwos"], {}),
            }

            def policy_mapping_fn(agent_id, episode, **kwargs):
                return "SoccerTwos" if "SoccerTwos" in agent_id else "Goalie"
